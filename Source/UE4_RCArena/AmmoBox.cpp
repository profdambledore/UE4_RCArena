...
AAmmoBox::AAmmoBox()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh>BoxMeshObject(TEXT("/Game/Box/Mesh/SM_AmmoBox"));
	...
	static ConstructorHelpers::FClassFinder<ABasePickup>PickupClass(TEXT("/Game/Pickup/Blueprint/BP_AmmoPickup"));
